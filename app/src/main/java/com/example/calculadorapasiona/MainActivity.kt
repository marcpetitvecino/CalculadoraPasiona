...
class MainActivity : AppCompatActivity() {
    ...
    private fun initListeners() {
        ...
        buttonCE.setOnClickListener { resetCalculator() }
        ...
        pasiona.setOnClickListener { Toast.makeText(this, "Benvingut a Pasiona! La millor empresa del mòn", Toast.LENGTH_SHORT).show() }
    }
